namespace EShopper.Service
{
    public class ImageOperations
    {
        ...
        public static async Task<string> UploadImageAsync(IFormFile file)
        {
            ...
            var path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot\\images\\home", newFileName);
        ...
        {
            var path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot\\images\\home", fileName);
